...
package wasi_http_0_3_0_rc_2025_09_16_types
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [stream-new-0][static]request.new
func wasm_stream_new_u8() uint64

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [async-lower][stream-read-0][static]request.new
func wasm_stream_read_u8(handle int32, item unsafe.Pointer, count uint32) uint32

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [async-lower][stream-write-0][static]request.new
func wasm_stream_write_u8(handle int32, item unsafe.Pointer, count uint32) uint32

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [stream-drop-readable-0][static]request.new
func wasm_stream_drop_readable_u8(handle int32)

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [stream-drop-writable-0][static]request.new
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [future-new-1][static]request.new
func wasm_future_new_result_option_fields_error_code() uint64

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [async-lower][future-read-1][static]request.new
func wasm_future_read_result_option_fields_error_code(handle int32, item unsafe.Pointer) uint32

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [async-lower][future-write-1][static]request.new
func wasm_future_write_result_option_fields_error_code(handle int32, item unsafe.Pointer) uint32

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [future-drop-readable-1][static]request.new
func wasm_future_drop_readable_result_option_fields_error_code(handle int32)

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [future-drop-writable-1][static]request.new
func wasm_future_drop_writable_result_option_fields_error_code(handle int32)

func wasm_future_lift_result_option_fields_error_code(src unsafe.Pointer) wit_types.Result[wit_types.Option[*Fields], ErrorCode] {
...
case 1:
        ...
        option = wit_types.Some[*Fields](FieldsFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(src), 12))))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option1 = wit_types.Some[uint16](uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(src), (18+3*4))))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option2 = wit_types.Some[uint8](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(src), 17)))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option5 = wit_types.Some[uint64](uint64(*(*int64)(unsafe.Add(unsafe.Pointer(src), 24))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option6 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), 20))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option9 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), (20+4*4)))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option11 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), 20))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option14 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), (20+3*4)))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option15 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), 20))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option18 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), (20+3*4)))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option19 = wit_types.Some[uint64](uint64(*(*int64)(unsafe.Add(unsafe.Pointer(src), 24))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option20 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), 20))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option23 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), (20+3*4)))))
default:
        panic("unreachable")
}
...
func wasm_future_lower_result_option_fields_error_code(
        ...
        value wit_types.Result[wit_types.Option[*Fields], ErrorCode],
        dst unsafe.Pointer,
) func() {
...
var wasm_future_vtable_result_option_fields_error_code = wit_types.FutureVtable[wit_types.Result[wit_types.Option[*Fields], ErrorCode]]{
	(24+4*4),
	8,
...
func MakeFutureResultOptionFieldsErrorCode() (*wit_types.FutureWriter[wit_types.Result[wit_types.Option[*Fields], ErrorCode]], *wit_types.FutureReader[wit_types.Result[wit_types.Option[*Fields], ErrorCode]]) {
	pair := wasm_future_new_result_option_fields_error_code()
	return wit_types.MakeFutureWriter[wit_types.Result[wit_types.Option[*Fields], ErrorCode]](&wasm_future_vtable_result_option_fields_error_code, int32(pair >> 32)),
		wit_types.MakeFutureReader[wit_types.Result[wit_types.Option[*Fields], ErrorCode]](&wasm_future_vtable_result_option_fields_error_code, int32(pair & 0xFFFFFFFF))
}

func LiftFutureResultOptionFieldsErrorCode(handle int32) *wit_types.FutureReader[wit_types.Result[wit_types.Option[*Fields], ErrorCode]] {
	return wit_types.MakeFutureReader[wit_types.Result[wit_types.Option[*Fields], ErrorCode]](&wasm_future_vtable_result_option_fields_error_code, handle)
}

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [future-new-2][static]request.new
func wasm_future_new_result_unit_error_code() uint64

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [async-lower][future-read-2][static]request.new
func wasm_future_read_result_unit_error_code(handle int32, item unsafe.Pointer) uint32

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [async-lower][future-write-2][static]request.new
func wasm_future_write_result_unit_error_code(handle int32, item unsafe.Pointer) uint32

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [future-drop-readable-2][static]request.new
func wasm_future_drop_readable_result_unit_error_code(handle int32)

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [future-drop-writable-2][static]request.new
...
case 1:
        ...
        option0 = wit_types.Some[uint16](uint16(uint16(*(*uint32)(unsafe.Add(unsafe.Pointer(src), (18+3*4))))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option1 = wit_types.Some[uint8](uint8(uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(src), 17)))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option4 = wit_types.Some[uint64](uint64(*(*int64)(unsafe.Add(unsafe.Pointer(src), 24))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option5 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), 20))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option8 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), (20+4*4)))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option10 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), 20))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option13 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), (20+3*4)))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option14 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), 20))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option17 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), (20+3*4)))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option18 = wit_types.Some[uint64](uint64(*(*int64)(unsafe.Add(unsafe.Pointer(src), 24))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option19 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), 20))))
default:
        panic("unreachable")
}
...
case 1:
        ...
        option22 = wit_types.Some[uint32](uint32(*(*int32)(unsafe.Add(unsafe.Pointer(src), (20+3*4)))))
default:
        panic("unreachable")
}
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [resource-drop]fields
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [resource-drop]request
...
func RequestFromBorrowHandle(handleValue int32) *Request {
	return RequestFromOwnHandle(handleValue)
}


//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [resource-drop]request-options
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [resource-drop]response
...
func ResponseFromBorrowHandle(handleValue int32) *Response {
	return ResponseFromOwnHandle(handleValue)
}


//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [constructor]fields
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [static]fields.from-list
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]fields.get
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]fields.has
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]fields.set
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]fields.delete
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]fields.get-and-delete
func wasm_import_method_fields_get_and_delete(arg0 int32, arg1 uintptr, arg2 uint32, arg3 uintptr) 

func (self *Fields) GetAndDelete(name string) wit_types.Result[[][]uint8, HeaderError] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
var result0 wit_types.Result[[][]uint8, HeaderError]
switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
case 0:
...
for index := 0; index < int(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), (2*4)))); index++ {
        ...
        result0 = wit_types.Ok[[][]uint8, HeaderError](result)
case 1:
        var variant HeaderError
switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4))) {
case 0:
...
default:
        ...
        result0 = wit_types.Err[[][]uint8, HeaderError](variant)
default:
        panic("unreachable")
}
result1 := result0;
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]fields.append
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]fields.copy-all
func wasm_import_method_fields_copy_all(arg0 int32, arg1 uintptr) 

func (self *Fields) CopyAll() []wit_types.Tuple2[string, []uint8] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]fields.clone
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [static]request.new
func wasm_import_static_request_new(arg0 int32, arg1 int32, arg2 int32, arg3 int32, arg4 int32, arg5 int32, arg6 uintptr) 

func RequestNew(headers *Fields, contents wit_types.Option[*wit_types.StreamReader[uint8]], trailers *wit_types.FutureReader[wit_types.Result[wit_types.Option[*Fields], ErrorCode]], options wit_types.Option[*RequestOptions]) (*Request, *wit_types.FutureReader[wit_types.Result[wit_types.Unit, ErrorCode]]) {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
result := wit_types.Tuple2[*Request, *wit_types.FutureReader[wit_types.Result[wit_types.Unit, ErrorCode]]]{RequestFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 0))))), LiftFutureResultUnitErrorCode(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))};
tuple := result
return tuple.F0, tuple.F1

}

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request.get-method
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request.set-method
func wasm_import_method_request_set_method(arg0 int32, arg1 int32, arg2 uintptr, arg3 uint32) int32

func (self *Request) SetMethod(method Method) wit_types.Result[wit_types.Unit, wit_types.Unit] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request.get-path-with-query
func wasm_import_method_request_get_path_with_query(arg0 int32, arg1 uintptr) 

func (self *Request) GetPathWithQuery() wit_types.Option[string] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request.set-path-with-query
func wasm_import_method_request_set_path_with_query(arg0 int32, arg1 int32, arg2 uintptr, arg3 uint32) int32

func (self *Request) SetPathWithQuery(pathWithQuery wit_types.Option[string]) wit_types.Result[wit_types.Unit, wit_types.Unit] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request.get-scheme
func wasm_import_method_request_get_scheme(arg0 int32, arg1 uintptr) 

func (self *Request) GetScheme() wit_types.Option[Scheme] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request.set-scheme
func wasm_import_method_request_set_scheme(arg0 int32, arg1 int32, arg2 int32, arg3 uintptr, arg4 uint32) int32

func (self *Request) SetScheme(scheme wit_types.Option[Scheme]) wit_types.Result[wit_types.Unit, wit_types.Unit] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request.get-authority
func wasm_import_method_request_get_authority(arg0 int32, arg1 uintptr) 

func (self *Request) GetAuthority() wit_types.Option[string] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request.set-authority
func wasm_import_method_request_set_authority(arg0 int32, arg1 int32, arg2 uintptr, arg3 uint32) int32

func (self *Request) SetAuthority(authority wit_types.Option[string]) wit_types.Result[wit_types.Unit, wit_types.Unit] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request.get-options
func wasm_import_method_request_get_options(arg0 int32, arg1 uintptr) 

func (self *Request) GetOptions() wit_types.Option[*RequestOptions] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()

        returnArea := uintptr(wit_runtime.Allocate(pinner, 8, 4))
        wasm_import_method_request_get_options((self).Handle(), returnArea)
var option wit_types.Option[*RequestOptions]
switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
case 0:
        
        option = wit_types.None[*RequestOptions]()
case 1:
        
        option = wit_types.Some[*RequestOptions](RequestOptionsFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
default:
        panic("unreachable")
}
result := option;
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request.get-headers
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [static]request.consume-body
func wasm_import_static_request_consume_body(arg0 int32, arg1 int32, arg2 uintptr) 

func RequestConsumeBody(this *Request, res *wit_types.FutureReader[wit_types.Result[wit_types.Unit, ErrorCode]]) (*wit_types.StreamReader[uint8], *wit_types.FutureReader[wit_types.Result[wit_types.Option[*Fields], ErrorCode]]) {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()

        returnArea := uintptr(wit_runtime.Allocate(pinner, 8, 4))
        wasm_import_static_request_consume_body((this).TakeHandle(), (res).TakeHandle(), returnArea)
result := wit_types.Tuple2[*wit_types.StreamReader[uint8], *wit_types.FutureReader[wit_types.Result[wit_types.Option[*Fields], ErrorCode]]]{LiftStreamU8(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 0))), LiftFutureResultOptionFieldsErrorCode(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))};
tuple := result
return tuple.F0, tuple.F1

}

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [constructor]request-options
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request-options.get-connect-timeout
func wasm_import_method_request_options_get_connect_timeout(arg0 int32, arg1 uintptr) 

func (self *RequestOptions) GetConnectTimeout() wit_types.Option[uint64] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request-options.set-connect-timeout
func wasm_import_method_request_options_set_connect_timeout(arg0 int32, arg1 int32, arg2 int64, arg3 uintptr) 

func (self *RequestOptions) SetConnectTimeout(duration wit_types.Option[uint64]) wit_types.Result[wit_types.Unit, RequestOptionsError] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
var result wit_types.Result[wit_types.Unit, RequestOptionsError]
switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
case 0:
        
        result = wit_types.Ok[wit_types.Unit, RequestOptionsError](wit_types.Unit{})
case 1:
...
default:
        ...
        result = wit_types.Err[wit_types.Unit, RequestOptionsError](variant)
default:
        panic("unreachable")
}
result1 := result;
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request-options.get-first-byte-timeout
func wasm_import_method_request_options_get_first_byte_timeout(arg0 int32, arg1 uintptr) 

func (self *RequestOptions) GetFirstByteTimeout() wit_types.Option[uint64] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request-options.set-first-byte-timeout
func wasm_import_method_request_options_set_first_byte_timeout(arg0 int32, arg1 int32, arg2 int64, arg3 uintptr) 

func (self *RequestOptions) SetFirstByteTimeout(duration wit_types.Option[uint64]) wit_types.Result[wit_types.Unit, RequestOptionsError] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request-options.get-between-bytes-timeout
func wasm_import_method_request_options_get_between_bytes_timeout(arg0 int32, arg1 uintptr) 

func (self *RequestOptions) GetBetweenBytesTimeout() wit_types.Option[uint64] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request-options.set-between-bytes-timeout
func wasm_import_method_request_options_set_between_bytes_timeout(arg0 int32, arg1 int32, arg2 int64, arg3 uintptr) 

func (self *RequestOptions) SetBetweenBytesTimeout(duration wit_types.Option[uint64]) wit_types.Result[wit_types.Unit, RequestOptionsError] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]request-options.clone
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [static]response.new
func wasm_import_static_response_new(arg0 int32, arg1 int32, arg2 int32, arg3 int32, arg4 uintptr) 

func ResponseNew(headers *Fields, contents wit_types.Option[*wit_types.StreamReader[uint8]], trailers *wit_types.FutureReader[wit_types.Result[wit_types.Option[*Fields], ErrorCode]]) (*Response, *wit_types.FutureReader[wit_types.Result[wit_types.Unit, ErrorCode]]) {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
...
result := wit_types.Tuple2[*Response, *wit_types.FutureReader[wit_types.Result[wit_types.Unit, ErrorCode]]]{ResponseFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 0))))), LiftFutureResultUnitErrorCode(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))};
tuple := result
return tuple.F0, tuple.F1

}

//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]response.get-status-code
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]response.set-status-code
func wasm_import_method_response_set_status_code(arg0 int32, arg1 int32) int32

func (self *Response) SetStatusCode(statusCode uint16) wit_types.Result[wit_types.Unit, wit_types.Unit] {
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [method]response.get-headers
...
//go:wasmimport wasi:http/types@0.3.0-rc-2025-09-16 [static]response.consume-body
func wasm_import_static_response_consume_body(arg0 int32, arg1 int32, arg2 uintptr) 

func ResponseConsumeBody(this *Response, res *wit_types.FutureReader[wit_types.Result[wit_types.Unit, ErrorCode]]) (*wit_types.StreamReader[uint8], *wit_types.FutureReader[wit_types.Result[wit_types.Option[*Fields], ErrorCode]]) {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
