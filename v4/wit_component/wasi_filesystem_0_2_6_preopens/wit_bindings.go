...
import (
	...
	"github.com/spinframework/spin-go-sdk/v4/wit_component/wasi_filesystem_0_2_6_types"
)
...
func GetDirectories() []wit_types.Tuple2[*wasi_filesystem_0_2_6_types.Descriptor, string] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(wit_runtime.Allocate(pinner, (2 * 4), 4))
	wasm_import_get_directories(returnArea)
	result := make([]wit_types.Tuple2[*wasi_filesystem_0_2_6_types.Descriptor, string], 0, *(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4)))
	for index := 0; index < int(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 4))); index++ {
		...
		result = append(result, wit_types.Tuple2[*wasi_filesystem_0_2_6_types.Descriptor, string]{wasi_filesystem_0_2_6_types.DescriptorFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(base), 0))))), value})
	}
