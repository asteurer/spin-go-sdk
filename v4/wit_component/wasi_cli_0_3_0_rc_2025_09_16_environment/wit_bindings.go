...
package wasi_cli_0_3_0_rc_2025_09_16_environment
...
//go:wasmimport wasi:cli/environment@0.3.0-rc-2025-09-16 get-environment
...
//go:wasmimport wasi:cli/environment@0.3.0-rc-2025-09-16 get-arguments
...
//go:wasmimport wasi:cli/environment@0.3.0-rc-2025-09-16 get-initial-cwd
func wasm_import_get_initial_cwd(arg0 uintptr) 

func GetInitialCwd() wit_types.Option[string] {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()
