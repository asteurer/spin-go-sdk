...
import (
	...
	"github.com/spinframework/spin-go-sdk/v4/wit_component/wasi_http_0_2_6_types"
)
...
func Handle(request *wasi_http_0_2_6_types.OutgoingRequest, options wit_types.Option[*wasi_http_0_2_6_types.RequestOptions]) wit_types.Result[*wasi_http_0_2_6_types.FutureIncomingResponse, wasi_http_0_2_6_types.ErrorCode] {
	...
	var result wit_types.Result[*wasi_http_0_2_6_types.FutureIncomingResponse, wasi_http_0_2_6_types.ErrorCode]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = wit_types.Ok[*wasi_http_0_2_6_types.FutureIncomingResponse, wasi_http_0_2_6_types.ErrorCode](wasi_http_0_2_6_types.FutureIncomingResponseFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 8))))))
	case 1:
		...
		case 22:
			var option11 wit_types.Option[wasi_http_0_2_6_types.FieldSizePayload]
			switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 16))) {
			case 0:

				option11 = wit_types.None[wasi_http_0_2_6_types.FieldSizePayload]()
			case 1:
				...
				option11 = wit_types.Some[wasi_http_0_2_6_types.FieldSizePayload](wasi_http_0_2_6_types.FieldSizePayload{option9, option10})
			default:
				panic("unreachable")
			}
		...
		result = wit_types.Err[*wasi_http_0_2_6_types.FutureIncomingResponse, wasi_http_0_2_6_types.ErrorCode](variant)
	default:
		panic("unreachable")
	}
	result31 := result
