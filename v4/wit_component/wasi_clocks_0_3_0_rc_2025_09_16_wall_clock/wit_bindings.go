...
package wasi_clocks_0_3_0_rc_2025_09_16_wall_clock
...
//go:wasmimport wasi:clocks/wall-clock@0.3.0-rc-2025-09-16 now
...
//go:wasmimport wasi:clocks/wall-clock@0.3.0-rc-2025-09-16 get-resolution
func wasm_import_get_resolution(arg0 uintptr) 

func GetResolution() Datetime {
        pinner := &runtime.Pinner{}
defer pinner.Unpin()

        returnArea := uintptr(wit_runtime.Allocate(pinner, 16, 8))
        wasm_import_get_resolution(returnArea)
result := Datetime{uint64(*(*int64)(unsafe.Add(unsafe.Pointer(returnArea), 0))), uint32(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 8)))};
return result
