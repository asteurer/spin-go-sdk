...
func HttpErrorCode(err *wasi_io_0_2_6_error.Error) wit_types.Option[ErrorCode] {
...
func (self *IncomingBody) Stream() wit_types.Result[*wasi_io_0_2_6_streams.InputStream, wit_types.Unit] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(wit_runtime.Allocate(pinner, 8, 4))
	wasm_import_method_incoming_body_stream((self).Handle(), returnArea)
	var result wit_types.Result[*wasi_io_0_2_6_streams.InputStream, wit_types.Unit]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = wit_types.Ok[*wasi_io_0_2_6_streams.InputStream, wit_types.Unit](wasi_io_0_2_6_streams.InputStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
	case 1:

		result = wit_types.Err[*wasi_io_0_2_6_streams.InputStream, wit_types.Unit](wit_types.Unit{})
	default:
		panic("unreachable")
	}
	result0 := result
...
func (self *OutgoingBody) Write() wit_types.Result[*wasi_io_0_2_6_streams.OutputStream, wit_types.Unit] {
	pinner := &runtime.Pinner{}
	defer pinner.Unpin()

	returnArea := uintptr(wit_runtime.Allocate(pinner, 8, 4))
	wasm_import_method_outgoing_body_write((self).Handle(), returnArea)
	var result wit_types.Result[*wasi_io_0_2_6_streams.OutputStream, wit_types.Unit]
	switch uint8(*(*uint32)(unsafe.Add(unsafe.Pointer(returnArea), 0))) {
	case 0:

		result = wit_types.Ok[*wasi_io_0_2_6_streams.OutputStream, wit_types.Unit](wasi_io_0_2_6_streams.OutputStreamFromOwnHandle(int32(uintptr(*(*int32)(unsafe.Add(unsafe.Pointer(returnArea), 4))))))
	case 1:

		result = wit_types.Err[*wasi_io_0_2_6_streams.OutputStream, wit_types.Unit](wit_types.Unit{})
	default:
		panic("unreachable")
	}
	result0 := result
